...
export default function NuevoEquipoPage() {
  ...
  return (
    <div className="max-w-lg">
      <p className="text-xs font-semibold tracking-widest uppercase text-brand-blue mb-1">Nuevo equipo</p>
      ...
      <form action={formAction} className="bg-white rounded-2xl border border-slate-200/80 shadow-sm p-6 flex flex-col gap-4">
        ...
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1">El equipo nace contigo como único miembro; podrás invitar al segundo desde la página del equipo.</p>
        </div>
